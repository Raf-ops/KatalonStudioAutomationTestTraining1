...
"click | css=#mail-64b67f9b-601a-41a9-9e13-053fdc2affbd .item-attachment |  | Ganti Locator Element dengan surat yang diinginkan (Surat harus ada pada list)"
selenium.click("css=#mail-64b67f9b-601a-41a9-9e13-053fdc2affbd .item-attachment")
...
"click | css=.ms-Icon--MailForward |  | "
selenium.click("css=.ms-Icon--MailForward")

"click | css=.ms-Icon--Add | Add Reviewer | "
selenium.click("css=.ms-Icon--Add")

"click | id=custom-search-form |  | "
selenium.click("id=custom-search-form")

"type | id=custom-search-form | Trainee | "
selenium.type("id=custom-search-form", "Trainee")

"sendKeys | id=custom-search-form | KEY_ENTER | "
selenium.sendKeys("id=custom-search-form", Keys.ENTER)
