...
"click | css=#list-menu-inbox > a | Menampilkan list Memorandum di menu Inbox | "
selenium.click("css=#list-menu-inbox > a")

"click | css=#list-menu-draft > a | Menampilkan list Memorandum di menu Draft | "
selenium.click("css=#list-menu-draft > a")

"click | css=#list-menu-outbox > a | Menampilkan list Memorandum di menu Outbox | "
selenium.click("css=#list-menu-outbox > a")

"click | css=#list-dispo-in > a | Menampilkan list Memorandum di menu Disposiiton | "
selenium.click("css=#list-dispo-in > a")

"click | css=#list-menu-rejected > a | Menampilkan list Memorandum di menu Rejected | "
